...
0040 IF I$="N" THEN 52
0050 GOSUB 1000
0052 REM ANNOUCNE WUMPUSII FOR ALL AFICIONADOS ... ADDED BY DAVE
0054 PRINT 
...
0210 REM 1-YOU,2-WUMPUS,3&4-PITS,5&6-PATS
0220 DIM L(6)
0230 DIM M(6)
0240 FOR J=1 TO 6
0250 L(J)=FNA(0)
...
1290 PRINT "   IF  THE ARROG CAN'T GO DHAT WAY(IE NO TUNNEL) IT MOFES"
